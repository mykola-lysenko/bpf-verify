...
| `hsiphash` | `hsiphash_2u32` (32-bit-output keyed ARX PRF) | 100,000 | native and BPF agree |
| `xxh32` | `xxh32` (32-bit xxHash: 32-bit multiply-by-prime + rotate) | 100,000 | native and BPF agree |
