/* BPF verification harness for zstd_decompress
...
#include "/home/ubuntu/bpf-next-0aa637869/lib/zstd/decompress/zstd_decompress.c"
...
int bpf_prog_zstd_decompress(void *ctx)
{
    return 0;
    return 0;
}
