/* BPF verification harness for dynamic_queue_limits
...
#include "/home/ubuntu/bpf-next-0aa637869/lib/dynamic_queue_limits.c"
...
int bpf_prog_dynamic_queue_limits(void *ctx)
{
